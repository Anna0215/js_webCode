...
<div style="margin-top:30px;">
    <link rel="stylesheet" href="/assets/js/payment/others/payres.css">
    <div class="selfPay pb70 main" v-if="show">
    ...
    created () {
        ...
        This.payres = JSON.parse(payres).data;
    ...
    methods: {
        ...
        next () {
            this.$router.replace('/others/index');
        }
    }
}