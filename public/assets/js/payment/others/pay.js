...
<div style="margin-top:30px;">
    <link rel="stylesheet" href="/assets/js/payment/others/pay.css">
...
//      }
        ...
        getPay () {
            ...
            this.$post('/wap/payment/orderpay',params,res=>{
                ...
                if(data.code==0){
                    localStorage.setItem('payres', JSON.stringify(data));
                    This.$router.replace('/others/payres');
                }else if(data.code==6){
        ...
        getSignCodeA () {
            ...
            this.$post('/wap/payment/othersigncode',{},res=>{
                ...
                if(data.code==0){
                    This.$msg('验证码发送成功');
                    This.TransNo = data.data.Rqirqsn;
                    This.msgdate = data.data.Rqirqdate;
                }else{
                    this.$msg(data.data);
                }
            });
