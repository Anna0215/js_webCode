...
layui.config({
    base: '/plugins/layui/easyCropper/', //layui自定义layui组件目录,根据自己具体项目结构而定
    ...
    var obj = {
        ...
        render: function(e){
            ...
            // 注意更改这里css的路径
            var cropperHtml = '<link rel="stylesheet" href="/plugins/layui/easyCropper/cropper.css">\n' +
                '<div class="layui-fluid" style="display: none; padding-bottom: 10px;" id="'+cropperDivId+'">\n' +
                '    <div class="layui-form-item" style="margin-top: 5px;margin-bottom: 0px;">\n' +
                '        <div class="layui-input-inline layui-btn-container" style="width: auto;">\n' +
                '            <label for="'+uploadId+'" class="layui-btn layui-btn-primary" style="margin-bottom: 0;">\n' +
            ...
            content.find(".layui-btn").on('click',function () {
                ...
                if(event === 'confirmSave'){
                    ...
                    var blob = processData(data.toDataURL('image/jpeg'));
    ...
    function processData(dataUrl) {
        ...
        try {
            ...
            if (e.name === 'TypeError' && window.BlobBuilder) {
                ...
                blob = builder.getBlob(); // imgType为上传文件类型，即 file.type
            } else {
